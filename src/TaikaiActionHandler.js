...
class TaikaiActionHandler extends AbstractActionHandler {

  constructor(ctx,handlerVersions) {
  ...
  async handleWithState(handle) {
    ...
    this.ctx.log.d(`Consuming Block number ${blockNumber}`);
...
module.exports = TaikaiActionHandler